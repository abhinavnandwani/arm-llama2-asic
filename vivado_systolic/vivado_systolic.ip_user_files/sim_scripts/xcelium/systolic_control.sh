...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../vivado_systolic.gen/sources_1/ip/CORTEXM3_AXI_0/rtl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.systolic_control xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.systolic_control -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log systolic_control_sc.so .tmp_log xcelium_lib waves.shm c.obj)
