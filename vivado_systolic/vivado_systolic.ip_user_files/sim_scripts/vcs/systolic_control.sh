...
#
# Script generated by Vivado on Sat Nov 02 22:13:30 -0500 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : systolic_control.sh
...
#
# Usage        : systolic_control.sh
#                systolic_control.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                systolic_control.sh [-reset_run]
#                systolic_control.sh [-reset_log]
#                systolic_control.sh [-help]
#
...
#                script (type 'systolic_control.sh -help' for more information).
#
...
# script info
echo -e "systolic_control.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./systolic_control.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../vivado_systolic.gen/sources_1/ip/CORTEXM3_AXI_0/rtl" \
  "../../../../../../../My/ Drive/College/alexnet-ai-accelerator/hardware/systolic_array_rtl/fifo_inject.sv" \
  "../../../../../../../My/ Drive/College/alexnet-ai-accelerator/hardware/systolic_array_rtl/systolic_control.sv" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.systolic_control xil_defaultlib.glbl -o systolic_control_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./systolic_control_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key systolic_control_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc systolic_control_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./systolic_control.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: systolic_control.sh [-help]\n\
Usage: systolic_control.sh [-step]\n\
Usage: systolic_control.sh [-lib_map_path]\n\
Usage: systolic_control.sh [-reset_run]\n\
Usage: systolic_control.sh [-reset_log]\n\
Usage: systolic_control.sh [-keep_index]\n\
Usage: systolic_control.sh [-noclean_files]\n\n\
