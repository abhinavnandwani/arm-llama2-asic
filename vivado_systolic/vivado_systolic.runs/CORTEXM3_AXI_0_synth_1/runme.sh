...
HD_PWD='G:/My Drive/College/alexnet-ai-accelerator/vivado_systolic/vivado_systolic.runs/CORTEXM3_AXI_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CORTEXM3_AXI_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CORTEXM3_AXI_0.tcl
